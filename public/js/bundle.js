...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deletePrice.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deletePrice = void 0;
...
//type is either 'password' or 'data'
var deletePrice = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dataId) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "http://localhost:3000/api/v1/price/".concat(dataId);
            _context.next = 4;
            return (0, _axios.default)({
              method: 'DELETE',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Cennnik został usunięty!');
            }
  ...
  return function deletePrice(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.deletePrice = deletePrice;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteStairs.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteStairs = void 0;
...
//type is either 'password' or 'data'
var deleteStairs = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dataId) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
  ...
  return function deleteStairs(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteStairs = deleteStairs;
...
var _deletePrice = require("./deletePrice");

var _deleteStairs = require("./deleteStairs");
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            form = new FormData(); // const images = document.getElementById('stairImages').files;
            // const imagesArr = [];
            // let file;
            ...
            _context4.next = 8;
            return (0, _deletePrice.deletePrice)(dataId);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            console.log('dataId', dataId);
            _context6.next = 7;
            return (0, _deleteStairs.deleteStairs)(dataId);
