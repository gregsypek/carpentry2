...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  form.append('email', document.getElementById('userEmail').value); // form.append('photo', document.getElementById('photo').files[0]);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            form.append('priceIncluded', document.getElementById('priceIncluded').value);
            form.append('additionals', document.getElementById('additionals').value);
            form.append('imageCover', document.getElementById('imageCover').files[0]); // form.append('photo', document.getElementById('photo').files[0]);
