      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            option = el.options[el.selectedIndex];
            dataId = option.getAttribute('data-id');
            console.log('dataId', dataId); // const form = new FormData();
