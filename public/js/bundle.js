        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Jesteś zalogowany!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            try {} catch (err) {
              (0, _alerts.showAlert)('error', 'Problem z wylogowaniem! Spróbuj później');
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase() === 'PASSWORD' ? 'Hasło' : 'Dane', " zaktualizowane!"));
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createPrice.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createPrice = void 0;
...
var createPrice = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Nowy cennik utworzony!');
            }
  ...
  return function createPrice(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.createPrice = createPrice;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createStairs.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createStairs = void 0;
...
//type is either 'password' or 'data'
var createStairs = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = 'http://localhost:3000/api/v1/stairs';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Nowa kategoria utworzona!');
            }
  ...
  return function createStairs(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.createStairs = createStairs;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addPhoto.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteCategory.js":[function(require,module,exports) {
"use strict";
...
var deleteCategory = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dataId, category) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "http://localhost:3000/api/v1/".concat(category, "/").concat(dataId);
            _context.next = 4;
            return (0, _axios.default)({
              method: 'DELETE',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Wybrana kategoria została usunięta!');
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deletePhotos.js":[function(require,module,exports) {
"use strict";
...
// type is either 'password' or 'data'
var deletePhotos = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // try {
            console.log('hej'); //   const url = `http://localhost:3000/api/v1/stairs/${id}`;
  ...
  return function deletePhotos(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.deletePhotos = deletePhotos;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"flexGap.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.checkFlexGap = void 0;

/* eslint-disable*/
// Fixing flexbox gap property missing in some Safari versions
var checkFlexGap = function checkFlexGap() {
  ...
  flex.parentNode.removeChild(flex); // console.log(isSupported);

  if (!isSupported) document.body.classList.add('no-flexbox-gap');
};

exports.checkFlexGap = checkFlexGap;
},{}],"stickyNav.js":[function(require,module,exports) {
"use strict";
...
var _createPrice = require("./createPrice");

var _createStairs = require("./createStairs");

var _addPhoto = require("./addPhoto");

var _deleteCategory = require("./deleteCategory");

var _deletePhotos = require("./deletePhotos");

var _flexGap = require("./flexGap");

var _stickyNav = _interopRequireDefault(require("./stickyNav"));
...
var userStairsForm = document.querySelector('.form__stairs');
var userAddPhoto = document.querySelector('.form__addPhoto');
var userDeletePrice = document.querySelector('.form__deletePrice');
var userDeleteStairs = document.querySelector('.form__deleteStairs');
var userDeletePhotos = document.querySelector('.form__deletePhotos');
...
if (year) year.textContent = currentYear; //Smooth scrolling animation

if (allLinks) allLinks.forEach(function (link) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save-password').textContent = 'Aktualizuje...';
...
if (userPriceForm) userPriceForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var form, additionalsArray, priceIncludedArray;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            form.append('title', document.getElementById('title').value); // form.append('price', document.getElementById('price').value);

            form.append('price', parseInt(document.getElementById('price').value));
            priceIncludedArray.map(function (item) {
...
if (userStairsForm) userStairsForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            form.append('imageCover', document.getElementById('imageCover').files[0]);
            form.append('description', document.getElementById('description').value); // form.append('images', document.getElementById('stairsImages').files[1]);

            form.append('images', document.getElementById('stairsImages').files[0]);
            form.append('summary', document.getElementById('stairsSummary').value); // form.append('photo', document.getElementById('photo').files[0]);
...
if (userAddPhoto) userAddPhoto.addEventListener('submit', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
    var el, option, dataId, form, images, imagesArr, file, i;
...
if (userDeletePrice) userDeletePrice.addEventListener('submit', /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(e) {
    var el, option, dataId;
...
if (userDeleteStairs) userDeleteStairs.addEventListener('submit', /*#__PURE__*/function () {
...
if (userDeletePhotos) userDeletePhotos.addEventListener('change', /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(e) {
    var selectedIndex, selectedCategory, selectedOption, selectedOptgroup, id;
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            e.preventDefault(); // console.log(e.target[e.target.selectedIndex].getAttribute('data-nr'));
            // const selectedValue = e.target[e.target.selectedIndex].value;

            selectedIndex = e.target[e.target.selectedIndex].getAttribute('data-nr');
            selectedCategory = e.target[e.target.selectedIndex].id; // const selectedOption = document.getElementById(`${selectedCategory}`);

            selectedOption = document.querySelector("[id=\"".concat(selectedCategory, "\"][data-nr=\"").concat(selectedIndex, "\"]"));
            console.log('222', selectedOption);
            selectedOptgroup = selectedOption.closest('optgroup');
            console.log('!', selectedOptgroup);
            id = selectedOptgroup.getAttribute('data-id');
            console.log('dane', id, selectedIndex); // const options = Array.from(
            ...
            _context7.next = 11;
            return (0, _deletePhotos.deletePhotos)(id, selectedIndex);
